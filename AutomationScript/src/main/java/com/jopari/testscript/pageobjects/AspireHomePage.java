...
public class AspireHomePage
{
	 ...
	 * @param driver
	 */
	public AspireHomePage(WebDriver driver)
	{
		this(driver, (IInternetBrowser) new FirefoxBrowser());
	}
	
	public AspireHomePage(WebDriver driver, IInternetBrowser browser)
	{
		this.driver = driver;
	...
	public LoginPage clickTimeSheetImg() throws WebDriverUtilException
	{
		WebDriverUtil.waitForElementByXpath("//*[@id='page']/table[3]/tbody/tr[1]/td[2]/table/tbody/tr[1]/td[2]/table/tbody//tr[3]/td[1]/a/img", 10, driver);
		WebDriverUtil.findElementByXpath("//*[@id='page']/table[3]/tbody/tr[1]/td[2]/table/tbody/tr[1]/td[2]/table/tbody//tr[3]/td[1]/a/img", driver).click();
		TestLogger.log(new InfoEvent(this.getClass(), "Clicked Time Sheet Image link"));
		WebDriverUtil.handlePopupWindow(driver);
		TestLogger.log(new InfoEvent(this.getClass(), "Switching to the new Window of Time Sheet!!"));
		sleep(3);
		
		return new LoginPage(driver, browser);
	}
	
	/*public LoginPage clic() throws WebDriverUtilException
	{
		WebDriverUtil.handlePopupWindow(driver);
		TestLogger.log(new InfoEvent(this.getClass(), "Clicked Time Sheet Image link"));
		sleep(2);
